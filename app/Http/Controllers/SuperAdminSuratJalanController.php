...
class SuperAdminSuratJalanController extends Controller
{
...
public function store(Request $request)
{
    ...
    {
        $suratJalan->load('suratJalanDetails.salesOrderDetail');
        $pdf = FacadePdf::loadView('superAdmin.suratJalan.pdf', compact('suratJalan'));
    ...
    public function showStockHistory()
    {
        ...
        return view('superAdmin.StockBarangSO.show', compact('histories'));
    }
}
