...
class SuperAdminJadwalKirimController extends Controller
{
    public function index()
    {
        $jadwalKirims = JadwalKirim::with('salesOrder')->get();
        return view('superAdmin.JadwalKirim.index', compact('jadwalKirims'));
    }

    public function create()
    {
        $salesOrders = SalesOrder::whereDoesntHave('jadwalKirim')->get();
        return view('superAdmin.JadwalKirim.create', compact('salesOrders'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('superAdmin.JadwalKirim.index')->with('success', 'Jadwal Kirim berhasil ditambahkan.');
    }

    public function edit(JadwalKirim $jadwalKirim)
    {
        $salesOrders = SalesOrder::all();
        return view('superAdmin.JadwalKirim.edit', compact('jadwalKirim', 'salesOrders'));
    }
    ...
    public function update(Request $request, JadwalKirim $jadwalKirim)
    {
        ...
        return redirect()->route('superAdmin.JadwalKirim.index')->with('success', 'Jadwal Kirim berhasil diperbarui.');
    }

    public function show(JadwalKirim $jadwalKirim)
    {
        return view('superAdmin.JadwalKirim.show', compact('jadwalKirim'));
    }
    ...
    public function destroy(JadwalKirim $jadwalKirim)
    {
        ...
        return redirect()->route('superAdmin.JadwalKirim.index')->with('success', 'Jadwal Kirim berhasil dihapus.');
    }
    ...
    public function printPDF(JadwalKirim $jadwalKirim)
    {
        ...
        $pdf = FacadePdf::loadView('superAdmin.JadwalKirim.pdf', compact('jadwalKirim'));
