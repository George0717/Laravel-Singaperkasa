...
class SalesOrderController extends Controller
{
    ...
    {
        // Load the details with the sales order
        $salesOrder->load('details');
        return view('pages.SalesOrder.edit', compact('salesOrder'));
    }
    ...
    public function update(Request $request, SalesOrder $salesOrder)
    {
        ...
        if ($request->hasFile('po_photo')) {
            ...
            if ($salesOrder->po_photo) {
                Storage::disk('public')->delete($salesOrder->po_photo);
            }
            $path = $request->file('po_photo')->store('po_photos', 'public');
            $salesOrder->po_photo = $path;
        }
        ...
        // Save the updated SalesOrder instance
        $salesOrder->save();
    
        // Update associated SalesOrderDetail records
        $salesOrder->salesOrderDetails()->delete(); // Optionally delete all existing details first
