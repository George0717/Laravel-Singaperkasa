...
class AdminSalesOrderController extends Controller
{
    public function index()
    {
        ...
        return view('admin.SalesOrder.index', compact('salesOrders'));
    }

    public function create()
    {
        $latestOrder = SalesOrder::latest()->first();
        return view('admin.SalesOrder.create');
    }
    ...
    public function dashboard(Request $request)
    {
        ...
        return view('admin.dashboard.dashboard', compact('totalSalesOrders', 'currentMonthSalesOrders', 'currentYearSalesOrders', 'labels', 'data', 'month', 'year'));
    }
    ...
    public function show(SalesOrder $salesOrder)
    {
        ...
        return view('admin.SalesOrder.show', compact('salesOrder'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.SalesOrder.edit', [
    ...
    public function printPDF(SalesOrder $salesOrder)
    {
        ...
        $pdf = FacadePdf::loadView('admin.SalesOrder.pdf', compact('salesOrder'));
