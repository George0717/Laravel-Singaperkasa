...
class SuperAdminSalesOrderController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('superAdmin.SalesOrder.create');
    }
    ...
    public function dashboard(Request $request)
    {
        ...
        return view('superAdmin.dashboard.dashboard', compact('totalSalesOrders', 'currentMonthSalesOrders', 'currentYearSalesOrders', 'labels', 'data', 'month', 'year'));
    }
