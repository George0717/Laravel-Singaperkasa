...
class AdminStockBarangController extends Controller
{
    public function index()
    {
        $stockBarang = StockBarang::all();
        return view('admin.stockBarang.index', compact('stockBarang'));
    }

    public function create()
    {
        return view('admin.stockBarang.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($existingItem) {
            ...
            return redirect()->route('admin.stockBarang.index')
    ...
    public function edit($id)
    {
        ...
        return view('admin.stockBarang.edit', compact('stockBarang'));
    }
