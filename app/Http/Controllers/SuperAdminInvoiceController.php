...
class SuperAdminInvoiceController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('superAdmin.Invoice.create', compact('salesOrders', 'invoiceNumber'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('superAdmin.invoice.index')->with('success', 'Invoice berhasil dibuat.');
    }
    ...
    public function show(Invoice $invoice)
    {
        ...
        return view('superAdmin.Invoice.show', compact('invoice', 'salesOrder'));
    }
    ...
    {
        $salesOrders = SalesOrder::all();
        return view('superAdmin.Invoice.edit', compact('invoice', 'salesOrders'));
    }
    ...
    public function update(Request $request, Invoice $invoice)
    {
        ...
        // Redirect ke halaman index invoice
        return redirect()->route('superAdmin.invoice.index')->with('success', 'Invoice berhasil diperbarui.');
    }
    ...
    {
        $invoice->delete();
        return redirect()->route('superAdmin.invoice.index')->with('success', 'Invoice berhasil dihapus.');
    }
    ...
    public function generatePDF(Invoice $invoice)
    {
        ...
        // Generate PDF
        $pdf = FacadePdf::loadView('superAdmin.Invoice.pdf', compact('invoice', 'salesOrder'));
