...
<div class="container mx-auto px-4">
    <h1 class="text-2xl font-semibold mb-4">Edit Stock Barang</h1>
    <form action="{{ route('superAdmin.stockBarang.update', $stockBarang->id) }}" method="POST">
        @csrf
        @method('PUT')
        <div class="mb-4">
        ...
        <button type="submit" class="bg-blue-600 hover:bg-blue-700 text-white font-medium py-2 px-4 rounded-md">Update</button>
    </form>
</div>
@endsection
