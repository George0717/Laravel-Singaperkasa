...
@section('content')
    <div class="container mx-auto p-6">
        ...
        <a href="{{ route('superAdmin.users.create') }}" class="inline-block bg-blue-500 text-white px-6 py-2 rounded-lg mb-4 hover:bg-blue-600 transition duration-300" onclick="konfirmasiBuat(event)">
            Tambah Pengguna
        </a>
            ...
            function konfirmasiBuat(event) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.location.href = "{{ route('superAdmin.users.create') }}";
                    }
                });
            }
