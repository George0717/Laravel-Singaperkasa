...
<div class="container mx-auto px-4 py-6">
    ...
    <form action="{{ route('admin.jadwalKirim.update', $jadwalKirim->id) }}" method="POST" class="bg-white p-8 shadow-md rounded-lg">
        @csrf
        @method('PUT')
        ...
        <div class="mb-4">
            ...
            <input type="text" id="tujuan_pengiriman" name="tujuan_pengiriman" value="{{ $jadwalKirim->tujuan_pengiriman }}" class="form-input mt-1 block w-full" required>
