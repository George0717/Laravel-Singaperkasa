...
<div class="container mx-auto my-8">
    <div class="max-w-4xl mx-auto bg-white p-6 rounded-lg shadow-lg">
        ...
        <div class="mt-6 text-right">
            <a href="{{ route('admin.invoice.generatePDF', $invoice->id) }}" class="inline-block px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700">Download PDF</a>
            <a href="{{ route('admin.invoice.generateXLS', $invoice->id) }}" class="inline-block px-4 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700 ml-4">Download XLS</a>
            <a href="{{ route('admin.invoice.index') }}" class="inline-block px-4 py-2 bg-gray-600 text-white rounded-lg hover:bg-gray-700">Kembali</a>
        </div>
    </div>
</div>
@endsection
