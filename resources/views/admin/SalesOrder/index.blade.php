...
<div class="container mx-auto px-4">
    ...
    <a href="{{ route('admin.salesOrders.create') }}" class="btn btn-primary mb-4">Buat Pesanan
        Penjualan Baru</a>
                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="actionsDropdown">
                            <li><a class="dropdown-item"
                                    href="{{ route('admin.salesOrders.show', $order) }}">Lihat</a></li>
                            <li><a class="dropdown-item"
                                    href="{{ route('admin.salesOrders.edit', $order) }}">Edit</a></li>
                            <li>
                                <form action="{{ route('admin.salesOrders.destroy', $order) }}" method="POST"
