...
use App\Http\Controllers\AdminStockBarangController;
...
Route::middleware(['auth', 'role:super-admin'])->prefix('super-admin')->group(function () {
    ...
    Route::put('/activity-log/{id}/restore', [ActivityLogController::class, 'restore'])->name('activityLog.restore');
...
Route::middleware(['auth', 'role:admin'])->prefix('admin')->group(function () {
    ...
    Route::get('admin/stockBarang', [AdminStockBarangController::class, 'index'])->name('admin.stockBarang.index');
    Route::get('admin/stockBarang/create', [AdminStockBarangController::class, 'create'])->name('admin.stockBarang.create');
    Route::post('admin/stockBarang/store', [AdminStockBarangController::class, 'store'])->name('admin.stockBarang.store');
    Route::get('admin/stockBarang/{id}/edit', [AdminStockBarangController::class, 'edit'])->name('admin.stockBarang.edit');
    Route::put('admin/stockBarang/{id}', [AdminStockBarangController::class, 'update'])->name('admin.stockBarang.update');
    Route::delete('admin/stockBarang/{id}', [AdminStockBarangController::class, 'destroy'])->name('admin.stockBarang.destroy');

    Route::get('/admin/riwayat', [AdminActivityLogController::class, 'index'])->name('admin.riwayat.index');
    Route::get('/admin/riwayat/{id}', [AdminActivityLogController::class, 'show'])->name('admin.riwayat.show');

    Route::put('/activitylog/{id}/restore', [AdminActivityLogController::class, 'restore'])->name('adminActivityLog.restore');
